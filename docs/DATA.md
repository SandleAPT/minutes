...
- **임차 게시판**(관리사무소, 회의록·공고): 30개씩 보기 기준 **1~6페이지 대조·적재 완전 완료(미수집 0, 4기 선거 공고 세트 완성)** — 마지막 확인 index **23838**(제3기 2020.12월 결과공고, 2020.12.30 게시). 다음 작업: **7페이지부터**(23838 이전 — 3기 초·2기, 3기 선거 공고 예상). 게시 안 된 것으로 보이는 것: 커뮤니티센터 2차 투표 실시 공고, 6기 선관위원 보궐 선출 결과 공고, 2021년 2·6·9·10월 임차 결과공고. 미확인: 30798(6기 1차 선출공고) 첨부 4건 중 3건.
