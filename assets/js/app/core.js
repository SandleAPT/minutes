...
const TENANT_TERMS = {
  1:{start:"", end:"", approx:true, note:"기간 미확인. 2017.11~2018.02 회의 확인 — 구자선 회장·진세택 부회장·윤정희(201)·박동선(212)·김광회(206), 총7명 중 2명 미상. 2018.2.27 회의가 마지막(같은 날 2기 후보 공고 게시). 당시 선거구 10개→2017.11 규약 개정으로 9개 통합"},
  2:{start:"", end:"", approx:true, note:"선거 2018.3.8~10(후보 공고 2.27 — 윤정희·진세택·옥승한·김현영·허은영·임영균 6명). 3.30 첫 소집 유회 → 5.11 임원 선출(회장 진세택·감사 한경열, 부회장 공석→7.25 허은영 격상). 재적 5→6(한경열)→7명(윤정희, 8월). 18차 임시 개최 공고(2020.3.20) 이후 결과공고 없음"},
