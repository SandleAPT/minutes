...
const TENANT_TERMS = {
  2:{start:"", end:"", approx:true, note:"기간 미확인. 2019.03~2020.03 회의(정기 6~8차·임시 14~17차) 결과공고 확인 — 진세택 회장·허은영 부회장·한경열 감사·윤정희·옥승한·김현영(총7명 중 1명 미상). 18차 임시 개최 공고(2020.3.20) 이후 결과공고 없음"},
