// data.json 재생성 스크립트 (2026-08-23: 2024년 입대의 13건(4기·5기) 추가 후 재발행) (GitHub Actions `refresh-data`에서 실행, 로컬에서는 `node scripts/build-data.mjs`) (re: 2026-08-24 요약 갱신·태그 정리 반영)
