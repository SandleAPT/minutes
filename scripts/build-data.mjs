// data.json 재생성 스크립트 (2026-08-22: 2025년 9~12월 회의록 7건 추가 후 재발행) (GitHub Actions `refresh-data`에서 실행, 로컬에서는 `node scripts/build-data.mjs`)
...
function isSystemRecord(id) { return String(id || "").startsWith("topic_summaries"); }
